...
export default function RecordsPage() {
  ...
  const monthName = currentDate.toLocaleDateString('zh-TW', { year: 'numeric', month: 'long', timeZone: 'Asia/Hong_Kong' });
                          ...
                          <div key={share.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <div className="flex justify-between items-center mb-3">
                              ...
                              <p className="text-xs text-gray-500">
                                {new Date(share.created_at).toLocaleDateString('zh-TW', { timeZone: 'Asia/Hong_Kong' })}
                              </p>
                            </div>
                          ...
                          return (
                            <div key={log.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                              <div className="flex justify-between items-center mb-3">
                                ...
                                <p className="text-xs text-gray-500">
                                  {logDate.toLocaleDateString('zh-TW', { timeZone: 'Asia/Hong_Kong' })}
                                </p>
                              </div>
                        ...
                        {allQuizResponses.map((response: any) => (
                          <div key={response.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <div className="flex justify-between items-center mb-3">
                              ...
                              <p className="text-xs text-gray-500">
                                {new Date(response.answered_at).toLocaleDateString('zh-TW', { timeZone: 'Asia/Hong_Kong' })}
                              </p>
                            </div>

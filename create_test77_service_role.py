#!/usr/bin/env python3
"""
Create Test Data for test77@andywong.me using Service Role Key
============================================================
This script uses the service role key to bypass RLS and create test data.
"""
...
# Load environment variables from both .env and frontend/.env.local
load_dotenv('.env')
load_dotenv('frontend/.env.local')

def main():
    """Main function"""
    print("🔧 Creating Test Data for test77@andywong.me using Service Role Key")
    print("=" * 70)
    ...
    # Use the correct user ID and group ID
